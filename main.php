...
<div class="col-lg-8 offset-lg-2 contens">
	...
	<div class="main">
	<h2>概要</h2>
	<div class="atext">ここはテストwebサイト</div>
	
	<h2>３か条</h2>
	<div class="atext">ルール</div>
	<div class=="rul"><ul>
		<li class="rlist"><strong>1.テスト</li>
		<li class="rlist">2.テスト</li>
		<li class="rlist">3.テスト</strong></li>
	</div></ul>
	<h2>会員</h2>
	<div class="rtext">通年受付中<br>
	メニュー内の新規登録または<a href="newmember.php">こちら</a>から。</div>
	</div>
