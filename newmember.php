...
<div class="col-lg-8 offset-lg-2 contens">
	...
	<form method="POST" action="writenewmember.php">
	<div class="newmember"><p>名前：<input type="text" name="memberName"></p></div>

	<p>
	<input type="submit" value="登録" class="btn-dark">
	<input type="reset" value="リセット" class="btn-dark">
	</p>
	</form>
	</div>
