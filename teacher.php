...
<div class="main">
	...
	<img src="images/newtop.png" class="active">
	</div>
	<p class="matu">名無　太郎<p>
	挨拶
	<p>こちらはテストサイトとなっております。</p>
	<h2>役員紹介</h2>
	<div class="container-fluid">
	
		<div class="row">
			<div class="col-lg-4 col-sm-12">
			<img src="images/1.png"><p>people1</p>
			</div>
			<div class="col-lg-4 col-sm-12">
			<img src="images/2.png"><p>people2</p>
			</div>
			<div class="col-lg-4 col-sm-12">
			<img src="images/3.png"><p>people3</p>
			</div>
		</div>
		
		<div class="row">
			<div class="col-lg-4 col-sm-12">
			<img src="images/4.png"><p>people4</p>
			</div>
			<div class="col-lg-4 col-sm-12">
			<img src="images/5.png"><p>people5</p>
			</div>
			<div class="col-lg-4 col-sm-12">
			<img src="images/6.png"><p>people6</p>
			</div>
		</div>
